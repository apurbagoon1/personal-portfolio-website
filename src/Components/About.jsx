...
const About = () => {
  ...
  return (
    <section
      id="about"
      className="bg-[#141e36] text-white py-10 md:py-20 px-4 md:px-8"
    >
          ...
          >
            ...
            <div className="space-y-4 text-gray-300 text-justify">
              <p>
                ...
                initially challenging, this foundational experience gave me a
                strong grasp of logic and problem-solving.
              </p>

              <p>
                Later, a web technology course introduced me to{" "}
                <span className="text-indigo-400 font-medium">Javascript</span>{" "}
                — and that changed everything. I was captivated by the
                creativity and interactivity of the web. Inspired by{" "}
                <span className="text-purple-400 font-medium">
                  Anisul Islam Sir's
                </span>{" "}
                tutorials, I dove deep into the world of frontend development.
                It sparked a passion that has only grown stronger with time.
              </p>
              ...
              <p>
                ...
                skills through real-world projects, building confidence with
                modern tools, frameworks, and best practices. I'm a constant
                learner — always staying updated and building things that
                matter.
              </p>
            </div>
          </div>
