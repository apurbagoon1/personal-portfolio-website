...
const Hero = () => {
  return (
    <section
      id="home"
      className="min-h-screen bg-[#0f172a] text-white pt-24 md:pt-42 px-4 md:px-8"
    >
      <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center justify-between">
        ...
        >
          <span className="inline-flex items-center gap-2 rounded-full border border-purple-800 px-5 py-1 bg-[#13203f] md:text-lg font-medium">
            <LuSparkles className="text-xl text-yellow-400 animate-pulse drop-shadow-[0_0_8px_rgba(253,224,71,0.9)]" />{" "}
          ...
          <div className="space-y-2">
            ...
            <TypeAnimation
              ...
              speed={50}
              repeat={Infinity}
              className="text-lg md:text-xl font-medium text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-cyan-400 to-indigo-400"
              cursor={true}
            />
          </div>
          ...
          <p className="text-gray-400 md:text-lg text-justify">
            ...
            that solve real-world problems. I specialize in creating responsive
        frontends and robust backend systems using modern JavaScript frameworks and
            technologies, with a strong focus on clean code, performance, and
          ...
          {/* Social Icons */}
          <div className="flex opacity-50 gap-6 md:gap-8 mb-6 md:mb-0 md:mt-8">
            <a
        ...
        >
          ...
          <div className="absolute right-[-50px] bottom-0 flex items-center text-purple-600 opacity-50">
            <span className="text-3xl md:text-4xl font-semibold absolute bottom-2 md:-left-2">
              /
            </span>
            <svg
              className="w-12 h-12"
