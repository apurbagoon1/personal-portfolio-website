    ...
    <section className="bg-[#0f172a] text-gray-300 py-16 px-4 md:px-8">
      <div className="max-w-5xl mx-auto">
        ...
        >
          <Link
            to="/#projects"
            className="inline-flex items-center px-4 py-2 border border-cyan-400 rounded-full text-cyan-400 hover:bg-cyan-400 hover:text-black transition"
          >
        ...
        <motion.h2
          ...
          initial="hidden"
          animate="visible"
          className="text-4xl font-bold text-center mb-8 text-gradient bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent"
        >
          {project.name}
        </motion.h2>
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <h3 className="text-2xl font-semibold mb-3 text-purple-400">Tech Stack</h3>
          <div className="flex flex-wrap gap-4">
            {project.techStack.map((tech, idx) => (
              <div
                key={idx}
                className="flex items-center gap-2 bg-gray-800 px-4 py-2 rounded-full shadow hover:scale-105 transition"
              >
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <h3 className="text-2xl font-semibold mb-3 text-purple-400">Key Features</h3>
        ...
        >
          ...
          <ul className="list-disc list-inside space-y-2">
            {project.futurePlans.map((f, idx) => <li key={idx}>{f}</li>)}
          </ul>
        </motion.div>
        ...
        >
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-3 bg-gray-900 border border-purple-400 text-purple-400 rounded-full hover:bg-purple-400 hover:text-black transition"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-6 py-3 bg-gray-900 border border-cyan-400 text-cyan-400 rounded-full hover:bg-cyan-400 hover:text-black transition"
          >
